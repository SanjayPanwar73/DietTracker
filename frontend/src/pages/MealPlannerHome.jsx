...
const MealPlannerHome = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-sans text-gray-800 dark:text-gray-100 flex flex-col">
      ...
      <div className="flex flex-col items-center justify-center px-4 py-12 text-center max-w-4xl mx-auto">
        ...
        <div className="bg-green-100 dark:bg-green-900/30 p-3 rounded-full mb-6 animate-fade-in-up">
        ...
        <p className="text-base md:text-lg text-gray-500 dark:text-gray-400 mb-8 max-w-lg mx-auto leading-relaxed">
      ...
      <div className="bg-white dark:bg-gray-800 py-12 border-t border-gray-100 dark:border-gray-700 flex-1">
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            
            {/* Feature 1 */}
            <div className="p-5 rounded-2xl bg-gray-50 dark:bg-gray-700 hover:bg-green-50 dark:hover:bg-green-900/20 transition duration-300 border border-transparent hover:border-green-100 dark:hover:border-green-800 group">
                <div className="w-10 h-10 bg-white dark:bg-gray-600 rounded-lg shadow-sm flex items-center justify-center mb-3 group-hover:scale-110 transition">
                    <Sparkles className="w-5 h-5 text-yellow-500" />
                </div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1">Personalized</h3>
            ...
            <div className="p-5 rounded-2xl bg-gray-50 dark:bg-gray-700 hover:bg-green-50 dark:hover:bg-green-900/20 transition duration-300 border border-transparent hover:border-green-100 dark:hover:border-green-800 group">
                ...
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1">Weekly Schedules</h3>
                <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
            ...
            <div className="p-5 rounded-2xl bg-gray-50 dark:bg-gray-700 hover:bg-green-50 dark:hover:bg-green-900/20 transition duration-300 border border-transparent hover:border-green-100 dark:hover:border-green-800 group">
                ...
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1">Save Time</h3>
                <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
